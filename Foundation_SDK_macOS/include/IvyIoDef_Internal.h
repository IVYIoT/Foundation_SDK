...
typedef enum
{
	...
	IVYIO_FOS_RECORD_TYPE_V3_IOTALARM = 0x00000001 << 14,
	IVYIO_FOS_RECORD_TYPE_V3_CRALARM = 0x00000001 << 15,
	IVYIO_FOS_RECORD_TYPE_V3_PETALARM = 0x00000001 << 16
...
typedef struct _IVYIO_RTSP_VIDEO_INFO_
{
	...
	int h;
	int key;
	int codecId; // see IVYIO_RTSP_CODEC_ID
...
typedef struct _IVYIO_TURN_INFO_
{
	unsigned short port;
	char ip[64];
}ATTRIBUTE_PACKED IVYIO_TURN_INFO, *PIVYIO_TURN_INFO;
