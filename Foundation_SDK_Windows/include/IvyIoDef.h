...
#define IVYIO_EVENT_DATA_LEN 1024 * 4
...
#define FRAME_TAG_PLAYBACK_S_FRAME 0x46534250
...
typedef enum { 
	...
	IVYIO_DEV_FOS_NVR = 1001,
	IVYIO_DEV_FOS_BPI = 1002,
	IVYIO_DEV_FOS_IPC_MJ = 1003,
    IVYIO_DEV_FOS_DOORBELL= 1004,
    IVYIO_DEV_FOS_DOORBELL_RING = 1005
}IVYIO_DEV_TYPE;
...
typedef enum
{
	IVYIO_RECORD_ERROR_NO_ENOUGE_SPACE = 90,
	IVYIO_RECORD_ERROR_MAX_FILE = 91,
	IVYIO_RECORD_ERROR_SOLUTION_CHG = 92,
	IVYIO_RECORD_ERROR_FILE_PATH_NOEXIST = 93,
	IVYIO_RECORD_ERROR_UNKNOW = 94,
    IVYIO_RECORD_ERROR_FRAME_FMT_CHG = 95
}IVYIO_RECORD_EVENT;
...
{
	IVYIO_UPGRADE_OK = 0,
	IVYIO_UPGRADE_IPC_UPDATING      = -16, 
	IVYIO_UPGRADE_NOT_FILE         = -17, 
	IVYIO_UPGRADE_FILE_NOT_DOWNLOAD   = -18, 
...
typedef struct _IVYIO_OPEN_PLAY_BACK_ARGS_TYPE0_
{
	...
	unsigned long long sTime; 
	unsigned long long eTime; 
	int streamType; // It's record type
